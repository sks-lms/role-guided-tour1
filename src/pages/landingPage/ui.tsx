...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-subtle">
          ...
          <nav className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <Button
                ...
                onClick={(e) => handlers.handleTutorLogin(e)}
              >
                Teacher's
              </Button>
            </div>
            ...
            <div className="py-4 space-y-4 border-t border-border/50 mt-4 text-center">
              ...
              <div className="flex flex-col space-y-2 pt-4">
                ...
                <Button
                  variant="outline"
                  onClick={() => {
                    handlers.setIsStudentModalOpen(true);
                    handlers.setIsMobileMenuOpen(false);
                  }}
                >
                  Student
                </Button>
      ...
      {/* Student Login Modal */}
      <StudentLoginModal open={state.isStudentModalOpen} onOpenChange={handlers.setIsStudentModalOpen} />
...
=======
            ...
            >
              <Badge className="mb-8 bg-gradient-to-r from-white/25 to-white/15 text-white border-white/40 backdrop-blur-md hover:bg-white/30 transition-all duration-500 hover:scale-105 shadow-2xl text-xl px-6 py-2">
                🚀 {state.t("hero.title")}
              </Badge>

              <h1 className="text-5xl lg:text-7xl font-bold mb-8 text-white leading-tight drop-shadow-2xl">
                <span className="inline-block animate-[slideUp_1s_ease-out] hover:scale-105 transition-transform duration-300">
                  {state.t("hero.title.main")}
                </span>
                <br />
              ...
              <p className="text-xl lg:text-2xl text-white/90 mb-10 leading-relaxed max-w-4xl mx-auto animate-[slideUp_1s_ease-out_0.4s_both] drop-shadow-lg font-light">
                {state.t("hero.subtitle")}
>>>>>>> Stashed changes
              </p>
...
=======
                  className="bg-white text-primary hover:bg-white/95 hover:scale-110 hover:shadow-2xl transition-all duration-500 group text-lg px-10 py-6 h-auto shadow-2xl rounded-2xl font-semibold relative overflow-hidden"
                  onClick={() => document.getElementById("features")?.scrollIntoView({ behavior: "smooth" })}
                >
                  <span className="relative z-10">{state.t("hero.cta.features")}</span>
>>>>>>> Stashed changes
...
=======
                  className="border-2 border-white/40 bg-white/10 text-white hover:border-white/60 hover:bg-white/20 backdrop-blur-md group text-lg px-10 py-6 h-auto shadow-2xl hover:scale-110 transition-all duration-500 rounded-2xl font-semibold relative overflow-hidden"
                  onClick={() => document.getElementById("pricing")?.scrollIntoView({ behavior: "smooth" })}
                >
                  <Play className="mr-3 h-6 w-6 group-hover:scale-125 transition-transform duration-300 relative z-10" />
                  <span className="relative z-10">{state.t("hero.cta.pricing")}</span>
...
=======
      ...
      <section id="features" className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-20">
            <div
              className={`transition-all duration-1000 delay-200 ${scrollY > 100 ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
                }`}
            >
              <Badge className="mb-6 bg-primary/10 text-primary border-primary/20 hover:bg-primary/20 transition-all duration-300">
                ✨ {state.t("features.title")}
              </Badge>
              <h2 className="text-3xl lg:text-4xl font-bold mb-6 bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent">
                {state.t("features.title")}
              </h2>
              <p className="text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                {state.t("features.subtitle")}
...
=======
                  ...
                  <CardContent className="p-8 text-center relative z-10">
                    <div
                      className={`w-20 h-20 bg-gradient-to-br ${feature.gradient} rounded-3xl flex items-center justify-center mx-auto mb-6 group-hover:scale-125 group-hover:rotate-12 transition-all duration-500 shadow-lg group-hover:shadow-2xl`}
                    >
                      <feature.icon className="h-10 w-10 text-white group-hover:animate-bounce" />
                    </div>
...
=======
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-20">
            <div
              className={`transition-all duration-1000 delay-300 ${scrollY > 400 ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
                }`}
            >
              <Badge className="mb-6 bg-secondary/20 text-secondary-foreground border-secondary/30 hover:bg-secondary/30 transition-all duration-300">
                🎯 How It Works
              </Badge>
              <h2 className="text-3xl lg:text-4xl font-bold mb-6">{state.t("howitworks.title")}</h2>
              <p className="text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                {state.t("howitworks.subtitle")}
              </p>
>>>>>>> Stashed changes
            </div>
          </div>
...
=======
            ...
            {[
              ...
              >
                <div
                  className={`w-24 h-24 bg-gradient-to-br ${item.gradient} rounded-full flex items-center justify-center mx-auto mb-8 text-white font-bold text-xl group-hover:scale-125 group-hover:rotate-12 transition-all duration-500 shadow-xl relative overflow-hidden`}
                >
>>>>>>> Stashed changes
...
=======
                <h3 className="font-semibold text-2xl mb-4 group-hover:text-primary transition-colors duration-300">
                  {item.title}
                </h3>
...
>>>>>>> Stashed changes
      ...
      <section id="pricing" className="py-20 relative">
        {/* Inserted subtle background pattern as requested */}
      ...
      <section className="py-20 bg-gradient-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              className="bg-white text-primary hover:bg-white/20 hover:text-white backdrop-blur-sm group shadow-2xl hover:scale-105 transition-all duration-300"
              onClick={(e) => handlers.handleTutorLogin(e)}
            >
              {state.t("cta.teach")}
            </Button>
            <Button
              size="lg"
              variant="outline"
              className="border-white bg-white/30 text-white hover:bg-white/50 hover:text-white hover:border-transparent backdrop-blur-sm group shadow-2xl hover:scale-105 transition-all duration-300"
              onClick={() => handlers.setIsStudentModalOpen(true)}
            >
              {state.t("cta.learn")}
            </Button>
          </div>
      ...
      <footer className="py-12 border-t border-border/50 relative">
        {/* Inserted background container for subtle gradient like 'How It Works' */}
            ...
            <ul className="flex gap-4 list-none m-0 p-0">
              <li>
                <a
                  ...
                  className="text-periwinkleBlue text-2xl flex items-center justify-center w-10 h-10 rounded-full bg-powderBlue transition-colors duration-200 ease-in-out hover:text-purple-600 hover:bg-lightPurple"
                >
                  <Twitter className="w-6 h-6" />
                </a>
              </li>
